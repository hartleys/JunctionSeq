...
echo ----- R-DEVEL CMD BiocCheck STARTING (%TIME%, %DATE%) -----  >   R-CMD-BiocCheck-WIN64-RDEVEL-v2015.11.12.log
C:/PROGRA~1/R/R-devel/bin/x64/R --version                     >>  R-CMD-BiocCheck-WIN64-RDEVEL-v2015.11.12.log 2>&1
echo --------------------------------------------------------------------        >>  R-CMD-BiocCheck-WIN64-RDEVEL-v2015.11.12.log
C:/PROGRA~1/R/R-devel/bin/x64/Rscript checker.R %VER% RDEVEL-v2015.11.12 %~dp0 WIN64
echo ----- R-DEVEL CMD BiocCheck COMPLETE (%TIME%, %DATE%) -----  >>  R-CMD-BiocCheck-WIN64-RDEVEL-v2015.11.12.log
...
echo ----- R CMD BiocCheck STARTING (%TIME%, %DATE%) ----- >  R-CMD-BiocCheck-WIN64-R-v3.2.2.log
C:/PROGRA~1/R/R-3.2.2/bin/x64/R --version              >> R-CMD-BiocCheck-WIN64-R-v3.2.2.log 2>&1
echo -------------------------------------------------------------------- >>  R-CMD-BiocCheck-WIN64-R-v3.2.2.log
C:/PROGRA~1/R/R-3.2.2/bin/x64/Rscript checker.R %VER% R-v3.2.2 %~dp0 WIN64
echo ----- R CMD BiocCheck COMPLETE (%TIME%, %DATE%) -----  >> R-CMD-BiocCheck-WIN64-R-v3.2.2.log
